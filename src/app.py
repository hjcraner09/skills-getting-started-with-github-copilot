...
activities.update({
    ...
    "Basketball Club": {
        "description": "Basketball drills, pickup games, and tournaments",
    ...
    "Art Club": {
        ...
        "max_participants": 20,
        "participants": ["nina@mergington.edu", "zoe@mergington.edu"]
    },
    "Drama Club": {
...
def is_student_signed_up(activity: dict, email: str) -> bool:
